        ...
        <div class="grid grid-cols-2 gap-28">
            <div class="relative">
                ...
                <p class="text-white leading-loose tracking-wide">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elementum fringilla ultricies eget amet
                    blandit
                    quis sit duis. Suspendisse fames venenatis volutpat urna dui. Quisque non diam mi ullamcorper.
                </p>
                <img class="w-12 -translate-x-10" src="../assets/images/footer2-img.webp" alt="">
            </div>
